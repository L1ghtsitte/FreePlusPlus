...
code_lines = [
    ...
    [("#F8F8F2", "{")],
    [("#FF79C6", "    int"), ("#F8F8F2", " age"), ("#F8F8F2", " = "), ("#BD93F9", "20"), ("#F8F8F2", ";")],
    [("#FF79C6", "    int"), ("#F8F8F2", " score"), ("#F8F8F2", " = "), ("#BD93F9", "85"), ("#F8F8F2", ";")],
    [],
    [("#FF79C6", "    if"), ("#F8F8F2", " (age >= "), ("#BD93F9", "18"), ("#F8F8F2", ") {")],
    [("#50FA7B", "      cout"), ("#F8F8F2", " << "), ("#F1FA8C", '"adult"'), ("#F8F8F2", ";")],
    [("#F8F8F2", "    }")],
    [],
    [("#FF79C6", "    if"), ("#F8F8F2", " (score >= "), ("#BD93F9", "80"), ("#F8F8F2", ") {")],
    [("#50FA7B", "      cout"), ("#F8F8F2", " << "), ("#F1FA8C", '"pass"'), ("#F8F8F2", ";")],
    [("#F8F8F2", "    }")],
    [],
...
draw.text((RX, rule_y + 18), "УСЛОВНЫЙ", font=sub_fnt, fill=WHITE)
draw.text((RX, rule_y + 78), "ОПЕРАТОР  if", font=sub_fnt, fill=GREEN_MID)
...
out = "/mnt/user-data/outputs/lesson_3.png"
img.save(out, "PNG")
print("Done:", out)
