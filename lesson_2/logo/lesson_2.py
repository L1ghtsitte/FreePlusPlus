...
code_lines = [
    ...
    [("#F8F8F2", "{")],
    [("#FF79C6", "    int"), ("#F8F8F2", " a"), ("#F8F8F2", " = "), ("#BD93F9", "10"), ("#F8F8F2", ", b = "), ("#BD93F9", "3"), ("#F8F8F2", ";")],
    [("#F8F8F2", "    a"), ("#F8F8F2", " += "), ("#BD93F9", "5"), ("#F8F8F2", ";")],
    [("#F8F8F2", "    b"), ("#F8F8F2", "++;")],
    [("#F8F8F2", "    ++"), ("#F8F8F2", "a"), ("#F8F8F2", ";")],
    [("#FF79C6", "    constexpr"), ("#F8F8F2", " int")],
    [("#F8F8F2", "      MAX"), ("#F8F8F2", " = "), ("#BD93F9", "8"), ("#F8F8F2", ";")],
...
sub_fnt = fnt(SANS_BOLD, 46)
draw.text((RX, rule_y + 18), "ДЕЙСТВИЯ НАД", font=sub_fnt, fill=WHITE)
draw.text((RX, rule_y + 72), "ПЕРЕМЕННЫМИ", font=sub_fnt, fill=GREEN_MID)
...
out = "/mnt/user-data/outputs/lesson_2.png"
img.save(out, "PNG")
print("Done:", out)
